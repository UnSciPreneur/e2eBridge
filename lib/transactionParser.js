...
function follow() {
  elasticClient.getHighestBlockIndex(function (topIndex) {
    loopOverBlocks(topIndex + 1, 10000000, true);
  })
}
...
function loopOverBlocks(blockNumber, maxBlockNumber, follow) {
  ...
  var transactionCountQuery = '{"jsonrpc":"2.0","method":"eth_getBlockTransactionCountByNumber","params":["0x' + blockNumber.toString(16) + '"],"id":1}';
